...
var configServer = JSON.parse(require('fs').readFileSync(require('path').join(__dirname, '..', 'conf', 'server.conf.local')).toString())
tagmanager.setTagList(configServer.taglib);
var configModules = JSON.parse(require('fs').readFileSync(require('path').join(__dirname, '..', 'conf', 'module.conf.local')).toString());
var modulecontainer = require('../lib/modulecontainer.js')(configModules);
var cnt = 0;
...
Renderer.prototype.render = function () {
    ...
    var self = this,
        body = HTMLRenderer.getViewBody(this.parseresult.document),
