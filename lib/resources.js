...
Resource.prototype.addDependency = function (resource) {
    ...
    if (this.state >= Resource.STATES.LOADINGDEPS) { throw new Error('dependencies may not be added after loading has startded'); }
...
Resource.prototype.loadDependencies = function () {
    ...
    logger.debug('loadDependencies resource ' + this.uuid);
