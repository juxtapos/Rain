...
var mod_fs 					= require('fs')
    ...
    , config = mod_fs.readFileSync(mod_path.join(__dirname, '..', 'conf', 'module.conf.local')).toString()
...
exports.COMPONENT_PROTOCOL      = COMPONENT_PROTOCOL;
