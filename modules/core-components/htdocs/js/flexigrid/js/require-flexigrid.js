...
(function ($) {
	$.addFlex = function (t, p) {
		...
		p = $.extend({ //apply default properties
			...
			onToggleCol: false,
			onChangeSort: false,
			onSuccess: false,	// a callback with maximum two parameters: (the flexigrid instance, data returned from ajax call)
			onError: false,
		...
		var g = {
			...
			addData: function (data) { //parse data
				...
				/**
				 * I added this so each callback onsuccess is aware of the returned
				 * values.
				 */
				if (p.onSuccess) {
